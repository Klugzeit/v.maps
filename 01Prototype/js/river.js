...
function loadMarkers() {
  ...
  $.getJSON(geojson_url, function(result) {
      ...
      $.each(data, function(key, val) {
        ...
        var markerInfo = "<div><h3>" + titleText + "</h3><p>" + infoPlace + "</p><img width='100%' src=" + imagePlace + "></div>"
        ...
        marker.addListener('click', function() 
        {
          ...
          if (window_width >= 1200) 
             {
              document.getElementById("boxInfo").style.width = "35%";
             }

         else if (window_width >= 992 && window_width <= 1199) 
           {
            document.getElementById("boxInfo").style.width = "40%";
           }

        else if (window_width >= 768 && window_width <= 991)
         {
            document.getElementById("boxInfo").style.width = "60%";
         }

        else if (window_width <= 767)
         {
            document.getElementById("boxInfo").style.width = "80%";
         }
...
function closeNav() 
{
    ...
    $("#shoppingButton").css("margin-right", "50px");
    map.setZoom(4);
}
...
$("#nextButton2").click(function() 
{
    ...
    var TutorialInfo = "<div><h3>This area shows the name of the community</h3><p>Here you can find more information, contact details and a nice picture of the community.</p><p>The '+' button adds the community to your backpack.</p></div>"
    $('#information').html(TutorialInfo)
    var window_width = $(window).width();
    if (window_width >= 1200) 
       {
        document.getElementById("boxInfo").style.width = "50%";
       }
